...
export class DatatableComponent implements OnInit {
  ...
  private valOfObj(obj: any, column: any, effect: boolean = true): any {
    const colLen = { Calculate: column.Image || (column.Badge && column.Badge.Char) ? false : true, Char: column.Image ? (column.Image.Char || column.Image.Width / 3) : column.Badge.Char };
